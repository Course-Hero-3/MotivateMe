      ...
      <div className="three-columns">
        ...
        <div className="column">
          <div className="welcome-card">
            <img id="dashboard-pfp"
              src={user?.image}
              alt="Profile Picture"
              onError={(event) => {
                event.target.src = "https://e7.pngegg.com/pngimages/753/432/png-clipart-user-profile-2018-in-sight-user-conference-expo-business-default-business-angle-service-thumbnail.png";
                event.onerror = null;
              }}
            />
